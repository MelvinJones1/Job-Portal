...
public class CourseModuleService {
	...
	public CourseModule getModule(int id) {
		return moduleRepo.findById(id).orElseThrow(() -> new RuntimeException("Module not found"));
	}

	public CourseModule updateModule(int id, String title, MultipartFile[] files) throws IOException {
		CourseModule module = moduleRepo.findById(id).orElseThrow(() -> new RuntimeException("Module not found"));
